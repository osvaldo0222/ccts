...
public class StatisticsApi {
    ...
    @Autowired
    public void setProvinceStatisticsService(ProvinceStatisticsService provinceStatisticsService) {
    ...
    public ResponseEntity<CustomResponseObjectDTO> getProvincesStatistics(){
        return new ResponseEntity<>(createResponse(HttpStatus.OK, provinceStatisticsService.getLastProvinceStatistics()),HttpStatus.OK);
    }
}
